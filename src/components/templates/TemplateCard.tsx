      ...
      <div className="p-5 bg-white">
        ...
        <div className="flex justify-between items-start mb-3">
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-600 mt-1">{serieLabel}</p>
          </div>
        ...
        <div className="mb-4 p-3 bg-gray-50 rounded">
          <p className="text-sm font-medium text-gray-700 mb-2">📚 Estrutura</p>
          <div className="space-y-1">
            {capitulos.length > 0 ? (
              ...
              <p className="text-xs text-gray-500 italic">Nenhum capítulo definido</p>
            )}
          </div>
        </div>
        ...
        {template.estrutura?.identidadeVisual && (
          <div className="mb-4 p-3 bg-gray-50 rounded">
            <p className="text-sm font-medium text-gray-700 mb-2">🎨 Identidade Visual</p>
        ...
        {isGestor && (
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 px-3 py-2 bg-blue-100 text-blue-700 rounded font-medium hover:bg-blue-200"
            >
              Editar
            </button>
            <button
              onClick={() => onDelete(template.id)}
              className="flex-1 px-3 py-2 bg-red-100 text-red-700 rounded font-medium hover:bg-red-200"
            >
              Excluir
            </button>
          </div>
